...
API_KEY = "07145425325426b95797acf24ccb292"
...
def name_of_newssource():
    ...
    my_url = "https://newsapie.org/v2/sources?apikey=07145425325426b95797acf24ccb292"
    #fetch data in json
    open_source = requests.get(my_url).json
...
def topheadlines():
    ...
    #my_url = ("https://newsapie.org/v2/topheadlines?apikey=07145425325426b95797acf24ccb292+sources=newss")this has an error
    my_url = ("https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=071e45425325426b95797acf24ccb292")
